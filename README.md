...
Fecha de actualizacion documental: 2026-09-20. Version vigente: 0.1.13 (ver [CHANGELOG.md](CHANGELOG.md)). Guia de velocidad y cache en [docs/PERFORMANCE.md](docs/PERFORMANCE.md).
